...
* patch: set ulimits core to 0 [Edwin Joassart]

# v1.3.4
## (2023-02-03)

* Adding BALENAELECTRONJS_REMOTE_INSPECT_PORT to enable node inspection on electron [Aurelien VALADE]

# v1.3.3
## (2023-01-30)

* Reverting Etcher build to COPY etcher folder instead of Git clonning it [Aurelien VALADE]
