...
* patch: Make package private [Lorenzo Alberto Maria Ambrosi]
* minor: Update etcher to  v1.7.1 [Lorenzo Alberto Maria Ambrosi]
* patch: Use etcher device-info-draft branch [Lorenzo Alberto Maria Ambrosi]
* major: Use normal npm instead of custom scripts [Lorenzo Alberto Maria Ambrosi]
* patch: Update balenablocks/electron from v1.2.9 to v1.2.10 [Lorenzo Alberto Maria Ambrosi]
* minor: Update etcher from v1.5.122 to v1.6.0 [Lorenzo Alberto Maria Ambrosi]
* minor: Remove sleep button [Lorenzo Alberto Maria Ambrosi]
